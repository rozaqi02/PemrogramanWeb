<?php
    // Menyertakan file auth.php untuk memastikan pengguna yang masuk sudah login
    include 'auth.php';
?>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
        ...
        <!-- Untuk menambah dan mengedit data anggota -->
    ...
    <script type="text/javascript">
        ...
        $("#simpan").click(function(){
            ...
            // Kirim permintaan AJAX jika validasi berhasil
            if (nama != "" && alamat != "" && (document.getElementById("jenkel1").checked == true || document.getElementById("jenkel2").checked == true) && no_telp != "") {
                $.ajax({
                    ...
                    data: data,
                    success: function() {
                        // Memuat ulang data setelah berhasil menyimpan/memperbarui data anggota
                        $('.data').load("data.php");
                        // Mereset form
